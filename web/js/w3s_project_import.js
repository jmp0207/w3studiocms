...
var w3sTemplateImport = Class.create({  
  
  show: function()
	{
	  var sActionPath = w3studioCMS.frontController + 'projectImport/show';
	...
	extract: function()
  {
    var sActionPath = w3studioCMS.frontController + 'projectImport/extract';
	...
	add: function(projectName){ 
	  ...
	  var sActionPath = w3studioCMS.frontController + 'projectImport/add';
