  ...
  public function fetchPagedLinks($parent, $queryVars) {
    ...
    if(!$parent->isFirstPage()) {
      if($currentPage != 1 && $currentPage != 2 && $currentPage != 3) {
          $str .= "<a href='?sp=1$queryVars' title='Start'>First</a> &lt; ";
      }
    }
    ...
    if(!$parent->isFirstPage()) {
      ...
      $str .= "<a href=\"?sp=$previousPage$queryVars\">&lt; previous</a> ";
    }
    ...
    if (!$parent->isLastPage()) {
      ...
      {
        $str .= " &gt; <a href=\"?sp=".$parent->fetchNumberPages()."$queryVars\" title=\"Last\">Last(".$parent->fetchNumberPages().") </a>";
      }
    }

    if(!$parent->isLastPage()) {
      $nextPage = $currentPage + 1;
      $str .= "<a href=\"?sp=$nextPage$queryVars\">next &gt;</a>";
    }
    return $str;
  }
}
